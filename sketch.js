...
launchSound = loadSound("rocket_launch.mp3");
spaceSound = loadSound("space.mp3");
winSound = loadSound("you_win_male.mp3");
loseSound = loadSound("you_lose_male.mp3");
explosionSound = loadSound("8bit_explosion.mp3");
...
explosion.scale = 0.5;
    ...
    if(y % 100===0)
    {
        astroidGroup.velocityYEach += 0.1;
    }
}
